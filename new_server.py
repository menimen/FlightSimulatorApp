...
#server example for ex1 , advanced prog 2
...
class FlightSimulator:
    ...
    def get_value(self, var_name: str):
        ...
        ################################################################# Increase values rapidly to test map boundaries
        # self.variables[var_name] = var_value + 1.0
    ...
    def process(self, command: str):
        try:
            ...
            ############################################################## Return invalid value for all variables
            # return "ERR"
...
class Server:
    ...
    def serve_client(self, client_socket: socket.socket, message_handler):
        ...
        with client_socket:
            ...
            ############################################################## Sleep one time immediately after connection
            # time.sleep(10)
            ...
            while data:
                ...
                for command in commands:
                    ...
                    ###################################################### Sleep before sending a message to client
                    # time.sleep(10)
